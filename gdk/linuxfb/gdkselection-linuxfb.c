 ...
 */
void
_gdk_linuxfb_selection_window_destroyed (GdkWindow *window)
{
...
gboolean
_gdk_linuxfb_display_set_selection_owner (GdkDisplay *display,
					  GdkWindow  *owner,
					   GdkAtom     selection,
					   guint32     time,
					   gboolean    send_event)
...
GdkWindow *
_gdk_linuxfb_display_get_selection_owner (GdkDisplay *display,
					  GdkAtom     selection)
{
  GSList *tmp_list;
  OwnerInfo *info;
...
void
_gdk_linuxfb_display_convert_selection (GdkDisplay *display,
					GdkWindow *requestor,
					 GdkAtom    selection,
					 GdkAtom    target,
					 guint32    time)
...
gint
_gdk_linuxfb_display_get_selection_property (GdkDisplay *display,
					     GdkWindow  *requestor,
					      guchar    **data,
					      GdkAtom    *ret_type,
					      gint       *ret_format)
...
void
_gdk_linuxfb_display_send_selection_notify (GdkDisplay      *display,
					    GdkWindow       *requestor,
					     GdkAtom          selection,
					     GdkAtom          target,
					     GdkAtom          property, 
...
gint 
_gdk_linuxfb_display_text_property_to_utf8_list (GdkDisplay    *display,
						 GdkAtom        encoding,
						  gint           format,
						  const guchar  *text,
						  gint           length,
...
gchar *
_gdk_linuxfb_display_utf8_to_string_target (GdkDisplay  *display,
					    const gchar *str)
{
  return g_strdup (str);
}
