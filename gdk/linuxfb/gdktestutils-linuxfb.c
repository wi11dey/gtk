...
void
_gdk_linuxfb_window_sync_rendering (GdkWindow *window)
{
  /* FIXME: Find out if there is a way to implement this on linuxfb. */
}

gboolean
_gdk_linuxfb_window_simulate_key (GdkWindow      *window,
				  gint            x,
				   gint            y,
				   guint           keyval,
...
gboolean
_gdk_linuxfb_window_simulate_button (GdkWindow      *window,
				     gint            x,
				      gint            y,
				      guint           button, /*1..3*/
				      GdkModifierType modifiers,
